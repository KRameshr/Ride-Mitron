...
export default function Dashboard() {
    ...
    const handleResponse = async (req, action) => {
        try {
            if (action === 'REJECT') {
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                        {requests.asPassenger.length === 0 ? (
                            ...
                            requests.asPassenger.map((req) => (
                                <div key={req._id} className="glass-panel group relative overflow-hidden active:scale-95 transition-transform">
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                        {requests.asDriver.length === 0 ? (
                            ...
                            requests.asDriver.map((req) => (
                                <div key={req._id} className="glass-panel hover:border-indigo-200 transition-colors">
